...
- **Observed photometry** — unmodified MAST file `tess2022302161335-s0058-0000000292152376-0247-s_lc.fits`, TESS Sector 58, DOI [10.17909/t9-nmc8-f686](https://doi.org/10.17909/t9-nmc8-f686). This is a real SPOC reduced light curve, not simulated data.
...
|---|---:|
| TESS sector | 58 |
| Cadences in fitted window | 6993 |
| Transit support | ΔBIC ≥ 10 |
| Midpoint correction | -0.009 h ± 0.12 min |
| Model mid-transit depth | 25870.4 ± 67.1 ppm |
| Radius ratio Rp/Rs | 0.15215 |
| Fitted / published duration | 3.254 / 3.120 h |
| Linear null χ² / dof / BIC | 202685.61 / 6991 / 202703.31 |
| Transit χ² / dof / BIC | 8083.21 / 6988 / 8127.47 |
| ΔBIC (null − transit) | 194575.84 |

The timing-adjusted transit is strongly preferred by ΔBIC = 194575.8. Its fitted midpoint is -0.009 hours from the historical prediction; the model's mid-transit depth is 25870.4 ± 67.1 ppm. A fitted timing correction can diagnose ephemeris drift, but this single-sector fit is not a replacement for a global transit-timing analysis.
...
<p align="center"><img src="figures/hatp32b_multisector_transits.png" alt="Independent sector transit fits for HAT-P-32 b" width="760"></p>

<p align="center"><img src="figures/hatp32b_depth_consistency.png" alt="Sector depth consistency for HAT-P-32 b" width="760"></p>

<p align="center"><img src="figures/hatp32b_noise_diagnostics.png" alt="Residual RMS time-averaging diagnostic for HAT-P-32 b" width="760"></p>
...
- Radius: 22.19 Earth radii
- Mass: 216.12 Earth masses
- Orbital period: 2.150008 days
- Transit duration: 3.120 hours
- Semi-major axis: 0.0340 AU
- Equilibrium temperature: 1836 K
- Host: HAT-P-32 · distance 289.20 pc
- Discovery: 2011 by Transit (HATNet)
...
1. [Hartman et al. 2011](https://ui.adsabs.harvard.edu/abs/2011arXiv1106.1212H/abstract) — discovery reference as listed by the NASA Exoplanet Archive.
2. Ricker, G. R. et al. (2015), *Transiting Exoplanet Survey Satellite (TESS)*, JATIS 1, 014003, [doi:10.1117/1.JATIS.1.1.014003](https://doi.org/10.1117/1.JATIS.1.1.014003).
3. TESS Team, *TESS Light Curves — All Sectors*, MAST, [doi:10.17909/t9-nmc8-f686](https://doi.org/10.17909/t9-nmc8-f686); Sector 58 used here.
